 ...
 *
 * Generated by JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178), 2016-10-06 14:28 +0200.
...
public /*@ nullable_by_default */ class Board_JML_Test {
   ...
   *
   * @param xSize The int to be passed.
   * @param ySize The int to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_Board__int_xSize__int_ySize__0")
  public void test_Board__int_xSize__int_ySize__0
  (final int xSize, final int ySize) {
    try {
      new Board(xSize, ySize);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_Board__int_xSize__int_ySize__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
   ...
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_Board__int_xSize__int_ySize__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_Board__int_xSize__int_ySize__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (Board_Board__int_xSize__int_ySize__0__xSize.class,
          Board_Board__int_xSize__int_ySize__0__ySize.class));
  }
